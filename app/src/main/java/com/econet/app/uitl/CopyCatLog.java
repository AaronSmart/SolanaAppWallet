...
{
    public static final String NAME = "copycatlog.txt";
    ...
    public CopyCatLog() 
    {
        ...
        //File temp = new File(context.getCacheDir().toString(), WHITE_LIST_DIR);
        File temp = new File(context.getFilesDir().getAbsolutePath(), WHITE_LIST_DIR);
        ///data/user/0/com.econet.solwallet/files
