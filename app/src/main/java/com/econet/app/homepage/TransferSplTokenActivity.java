...
public class TransferSplTokenActivity extends BaseActivity {
    ...
    String  donateSolAddress="Gwz377J8Uy5U3oQW81aYroLQSNJSJ8ZEDPyY1jexQfFz";
        ...
        lyLogin.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v)
            {
                ...
                if(checkData())
                {
                    ...
                    HttpUtil.getDataFromServerUsePost(ParseSplTokenUtil.Solana.solMainNet,json,headers,new Callback(){
                        @Override
                                        ...
                                        else// a little dangerous, we don't know what is the destination account type
                                        {
                                            ...
                                            try {
                                                ...
                                                if(resultSignature.length()==88||resultSignature.length()==87)
                                                {
                                                    ...
                                                    {
                                                        hideLoadingDialog();
                                                        CustomToast.showToast(TransferSplTokenActivity.this,"transfer success");
                                                        if(isDonate){SolanaTransferUtil.transferSol(solAddress,donateSolAddress,donateSolAmount,signer);}
                                                    }else
                                                    {
                                                        hideLoadingDialog();
