...
public class AddSplTokenActivity extends BaseActivity {
    ...
    private void initWidget()
    {
        ...
        ivTokenSearch.setOnClickListener(new View.OnClickListener(){
            ...
            public void onClick(View arg0) {
                ...
                bundle.putSerializable("fromAddToken","1");
    ...
    private boolean checkData()
    {
        ...
        if(etTokenMint.getText().toString().trim().length()<42)//weak check
        {
            CustomToast.showToast(AddSplTokenActivity.this,"Please input the right token mint");
            return false;
        }
        return true;
    }
